...
"古兰经"（以下简称"本应用"）是一款古兰经阅读与聆听工具。我们高度重视您的隐私，本应用不收集、不存储、不传输任何个人信息。
...
本应用在您的设备上本地存储以下数据，这些数据不会上传到任何服务器：
...
"Quran" (hereinafter "this App") is a Quran reading and listening tool. We highly value your privacy. This App does not collect, store, or transmit any personal information.
...
- No collection of names, emails, phone numbers, or other personal information
- No analytics tools or third-party tracking SDKs
- No advertisements or ad tracking

### Local Storage

This App stores the following data locally on your device. This data is never uploaded to any server:

- **Reading progress** — Records your recently read chapters and pages
...
This App does not integrate any third-party analytics, advertising, or social media SDKs.
